...
class WatermarkBase:
    def __init__(
        ...
        device = None,
        hash_key: float = 15485863, #passing this as a parameter to make it easy to generate results with differnet watermark keys
    ):
        ...
        self._initialize_seeding_scheme(seeding_scheme, hash_key)
        # Legacy behavior:
        self.select_green_tokens = select_green_tokens

    def _initialize_seeding_scheme(self, seeding_scheme: str, hash_key: float) -> None:
